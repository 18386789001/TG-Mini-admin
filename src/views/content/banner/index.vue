...
import { getList,del,change } from '/@/api/content/index';

// 引入组件
const Table = defineAsyncComponent(() => import('/@/components/table/index.vue'));
const TableSearch = defineAsyncComponent(() => import('/@/components/table/search.vue'));
const EditDialog = defineAsyncComponent(() => import('/@/views/content/banner/form/edit.vue'));
...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'type', colWidth: '',  title: '类型', type: 'radio', dict: { '1': 'Home', '2': '活动' }, isCheck: true },
			{ key: 'url', colWidth: '100', title: '跳转地址', type: 'text', isCheck: true },
			...
			{key:'content',colWidth: '', title: '描述', type: 'text',isCheck: true},
