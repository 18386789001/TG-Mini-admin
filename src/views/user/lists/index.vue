...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'nickname', colWidth: '', title: '姓名', type: 'text', isCheck: true },
			...
			{key:'sex',colWidth: '', title: '性别', type: 'radio',dict:{'1':'女','0':'男'},isCheck: true},
			{key:'day',colWidth: '', title: '生日', type: 'text',isCheck: true},
			{key:'signature',colWidth: '100', title: '个性签名', type: 'text',isCheck: true},
			{key:'industry',colWidth: '', title: '行业', type: 'text',isCheck: true},
			{key:'member_level',colWidth: '100', title: '会员等级', type: 'text',isCheck: true},
			{key:'member_points',colWidth: '100', title: '会员积分', type: 'text',isCheck: true},
			{ key: 'openid', colWidth: '', title: 'openid', type: 'radio', dict:{'1':'正常','0':'禁用','2':'待审核'},isCheck: true },
			// { key: 'hobby', colWidth: '200', title: '业余爱好', type: 'datetime', isCheck: true },
			{ key: 'hobby', colWidth: '200', title: '业余爱好', type: 'text', isCheck: true },
