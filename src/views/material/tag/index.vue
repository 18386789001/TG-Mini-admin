...
import { userInformation } from '/@/api/userManagment/index';
...
const state = reactive<TableDemoState>({
	tableData: {
		...
		// 表头内容（必传，注意格式）
		header: [
			{ key: 'chatId', colWidth: '80', title: 'ID', type: 'number', isCheck: true },
			{ key: 'userName', colWidth: '', title: 'NICKNAME', type: 'text', isCheck: true },
			{ key: 'headimgUrl', colWidth: '', width: '40', height: '40', title: 'AVATAR', type: 'image', isCheck: true },
			{ key: 'createTime', colWidth: '', title: 'TIME', type: 'number', isCheck: true },
			{ key: 'points', colWidth: '', title: 'USER POINTS',type: 'number', isCheck: true },
			{ key: 'walletUrlList', colWidth: '', title: 'USER WALLET',type: 'number', isCheck: true },
            { key: 'hp', colWidth: '', title: 'USER HP',type: 'number', isCheck: true },
            { key: 'userCode', colWidth: '', title: 'INVITE FRIENDS CODE',type: 'number', isCheck: true },
		...
		// search: [
		// 	{ label: 'NAME', prop: 'realname', placeholder: 'please enter your name', required: false, type: 'input' },
		// ],
...
const getTableData = () => {
	...
	userInformation(state.tableData.param).then((response: any) => {
