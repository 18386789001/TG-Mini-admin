			...
			<el-row>
				...
				<el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8" class="mb20">
					<el-form-item class="table-form-btn" :label-width="search.length <= 1 ? '10px' : '100px'">
						...
						<div>
							<el-button size="default" type="primary" @click="onSearch(tableSearchRef)">lookup </el-button>
							<el-button size="default" type="info" class="ml10" @click="onReset(tableSearchRef)"> reset </el-button>
							<el-button size="default" type="success" class="ml10"  v-if="isAdd" @click="onAdd()">新增</el-button>
						</div>
					</el-form-item>
				</el-col>
			</el-row>
