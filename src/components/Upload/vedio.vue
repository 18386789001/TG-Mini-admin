<template>
  <div class="upload-container"  style="width: 80%;">
    ...
    <el-link type="success"  style="font-size: 10px;" :underline="false"> 视频支持mp4格式；大小不超过1G ;</el-link>
...
const props = defineProps({
  ...
  action: {
		type: String,
		default: () => import.meta.env.VITE_API_URL + '/upload/media',
	},
  //展示信息
  msg: {
		type: String,
